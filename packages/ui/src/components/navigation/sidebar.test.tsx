...
describe('Sidebar Component Suite', () => {
  ...
  it('renders nested menu sub-items with active state', () => {
    render(
      <SidebarProvider defaultOpen={true}>
        <Sidebar>
          <SidebarContent>
            <SidebarMenu>
              <SidebarMenuItem>
                <SidebarMenuButton>Patterns</SidebarMenuButton>
                <SidebarMenuSub>
                  <SidebarMenuSubItem>
                    <SidebarMenuSubButton href="/patterns/stepper">Stepper</SidebarMenuSubButton>
                  </SidebarMenuSubItem>
                  <SidebarMenuSubItem>
                    <SidebarMenuSubButton href="/patterns/kanban" isActive>
                      Kanban
                    </SidebarMenuSubButton>
                  </SidebarMenuSubItem>
                </SidebarMenuSub>
    ...
    const stepper = screen.getByRole('link', { name: /stepper/i });
    expect(stepper).toBeDefined();
    expect(stepper.getAttribute('href')).toBe('/patterns/stepper');
