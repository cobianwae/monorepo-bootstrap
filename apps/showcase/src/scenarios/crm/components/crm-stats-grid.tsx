...
export function CrmStatsGrid({ isLoading = false }: CrmStatsGridProps) {
  ...
  return (
    <div className="grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-4">
      ...
      <Card className="relative flex flex-col justify-between p-5 rounded-xl border border-primary/35 bg-gradient-to-b from-primary/[0.04] via-card to-card shadow-xs transition-all duration-200 hover:border-primary/60 hover:shadow-sm">
        ...
        <div className="space-y-3">
          ...
          <div>
            <div className="font-display text-2xl sm:text-3xl font-extrabold text-foreground tabular-nums tracking-tight">
              ${totalCalculatedPipeline.toLocaleString()}
            </div>
            <p className="text-xs text-muted-foreground font-mono mt-1">
              82% pacing toward $1.02M quota
            </p>
          </div>
        </div>
      </Card>
      ...
      {/* 2. Win Rate */}
      <Card className="flex flex-col justify-between p-5 rounded-xl border border-border/80 bg-card shadow-xs transition-all duration-200 hover:border-border hover:shadow-sm">
        <div className="space-y-3">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-2.5">
      ...
      <Card className="flex flex-col justify-between p-5 rounded-xl border border-border/80 bg-card shadow-xs transition-all duration-200 hover:border-border hover:shadow-sm">
        <div className="space-y-3">
          <div className="flex items-center justify-between">
            ...
            <span className="inline-flex items-center gap-1 font-mono text-xs font-semibold text-warning">
      ...
      <Card className="flex flex-col justify-between p-5 rounded-xl border border-border/80 bg-card shadow-xs transition-all duration-200 hover:border-border hover:shadow-sm">
        <div className="space-y-3">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-2.5">
              <div className="flex h-8 w-8 shrink-0 items-center justify-center rounded-lg bg-highlight/10 text-highlight">
            ...
            <span className="inline-flex items-center gap-1 font-mono text-xs font-semibold text-highlight">
